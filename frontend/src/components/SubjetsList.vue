  ...
  <div>
    <div class="addBtn">
      <button class="aniadir" @click="goToCreateAsignatura" title="Crear nueva asignatura">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="50" height="24" color="#FFFFFF" fill="none">
          <path
      ...
      <div v-for="asignatura in asignaturas" :key="asignatura.id" class="card">
        ...
        <div class="card-body">
          ...
          <div class="card-actions">
            <button @click="goToEditAsignatura(asignatura.id)" class="btn btn-primary" title="Editar">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="#FFFFFF"
                fill="none">
                <path d="M7.01428 16.0029H11.0143M7.01428 11.0053H15.0143" stroke="currentColor" stroke-width="1.5"
            ...
            <button class="btn btndelete" @click="openDeleteModal(asignatura.id)" title="Eliminar">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="#FFFFFF"
                fill="none">
                <path
            ...
            <button @click="showDetails(asignatura)" class="btn btn-secondary" title="Ver detalles">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="#FFFFFF"
                fill="none">
                <path
...
const deleteAsignatura = async () => {
  try {
    if (asignaturaToDelete.value) {
      ...
      deleteModalVisible.value = false; // Cierra el modal al eliminar la asignatura
    }
  } catch (error) {
