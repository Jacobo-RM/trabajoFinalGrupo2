<template>
  <div>
    <div v-if="curso">
      <div class="addBtn">
        <button @click="goBack" title="Volver" class="aniadir">
          <svg
...
const goToCreateAsignatura = () => {
  router.push({
    ...
    query: { cursoEditable: false, cursoId: curso.value.id },
  });
};
